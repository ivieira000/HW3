...
Group: Nikki Reid, Chris T., Mostafa, Charles, Kadiri. 
date: "10/3/2020"
...
require(class)
for (indx in seq(1, 9, by= 2)) {
 pred_borough_2 <- knn(train_data_2, test_data_2, cl_data_2, k = indx, l = 0, prob = FALSE, use.all = TRUE)
num_correct_labels_2 <- sum(pred_borough_2 == true_data_2)
