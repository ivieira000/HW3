...
I'm not sure why this happens, but it might be because the variables I chose to add are not really correlated to the citzenship status and do not classify as well as I expected them to. 
